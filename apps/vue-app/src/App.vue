<template>
  <div class="app">
    <header class="app-header">
      <h1>Vue App with Universal Design System</h1>
      <p>This app demonstrates Vue components and islands working together</p>
    </header>

    <main class="app-main">
      <section class="component-section">
        <h2>Native Vue Components</h2>
    ...
    <footer class="app-footer">
      <p>Universal Design System - Vue Example</p>
    </footer>
  </div>
</template>
...
const VueInput = InputComponent.toVue().component;

// Register components in the island manager
islandManager.register('VueButton', VueButton, {
  framework: 'vue',
  ssr: true,
  hydrate: true,
  priority: 'high',
...
islandManager.register('VueInput', VueInput, {
  framework: 'vue',
  ssr: true,
  hydrate: true,
  priority: 'normal',
...
onMounted(async () => {
  try {
    ...
    console.log('Vue islands initialized successfully');
  } catch (error) {
    console.error('Failed to initialize Vue islands:', error);
  }
});
</script>
